//
//  LMPhotoPreviewCollectionViewLayout.h
//  LemonPhotoCleaner
//
//  
...
#define SLIDE_SHADOW_MARGIN    5.0     // margin on each side between the actual slide shape edge and the edge of the SlideCarrier image
...
@interface LMPhotoPreviewCollectionViewLayout : NSCollectionViewFlowLayout
