...
@implementation PhotoCleanerBlurView
...
+ (NSImage *)blur:(NSView*)view frame:(CGRect) frame{
    ...
    CGImageRef imageRef = [[self class] nsImageToCGImageRef:imageCopy];
    CIImage *inputImage = [[CIImage alloc] initWithCGImage:imageRef];
    CFRelease(imageRef);
